...
@section('content')
    ...
    <div class="row p-0">
        <div class="col-8 m-0">
            <p class="mt-4 m-0 text-center" style="font-size: 145%;">Bạn tìm kiếm truyện với từ khóa là : <b
                    class="ml-1">{{ $tukhoa }}</b></p>
                                        ...
                                        <div class=" shadow-sm" style="width: 100%;border-radius: 8px;">
                                            <div class="image_book_box float-left" style="width: 35%;">
                                                <img src="{{ asset('public/uploads/truyen/' . $value->hinhanh) }}"
                                                    width="100%" height="200px" style="border-radius: 8px">
                                            </div>
                                            <div class="image_book_box pl-2 float-right" style="width: 65%;">

                                                <a href="{{ url('xem-truyen/' . $value->slug_truyen) }}"
                                                    class="text-dark">
                                                    <p class="title_story mb-0 font-weight-bold"
                                                        style="font-size: 110%;margin-top: 5px;">{{ $value->tentruyen }}</p>
                        ...
                        @else
                            ...
                            @endif -->
                                                ...
                                                <div class="tag_box">
                                                    ...
                                                    <a>
                                                        <div class="btn mt-1 font-weight-bold"
                                                ...
                                                <p style="font-size: 85%; color:gray" class="comment_story m-0"> <i
                                                        class="fa fa-eye mr-1"></i>{{ views($value)->count() }} lượt xem
                                                </p>
