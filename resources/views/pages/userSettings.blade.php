    ...
    <div class="p-2 shadow-sm" style="border-radius: 8px;">
      <div class="row">
        ...
        <div class="form-group col-lg-12 col-sm-6">
          ...
          <input type="text" class="form-control" value="{{$user->phone_number}}" placeholder="Nhập số điện thoại" name="phone_number">
        </div>
        <div class="form-group col-lg-12 col-sm-6">
          <label for="pwd">Giới tính:</label>
          <select name="sex" class="form-control">
            <option value="0" for="pwd">Nam</option>
            <option value="1" for="pwd">Nữ</option>
          </select>
        </div>
        <div class="form-group col-lg-12 col-sm-6">
          <label for="pwd">Địa điểm:</label>
          <input type="text" class="form-control" name="location" value="{{$user->location}}" placeholder="Nơi ở của bạn">
        </div>
      </div>
