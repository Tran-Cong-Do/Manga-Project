...
<div class="row p-0">
  ...
  <div class="col-4 m-0">
    ...
    <div class="mt-4">
              ...
              <div class=" shadow-sm" style="width: 100%;border-radius: 8px;">
                <a href="{{$history->url}}">
                  <div class="image_book_box float-left" style="width: 30%;">
                    <img src="{{asset('public/uploads/truyen/'.$history->hinhanh)}}" width="100%" height="150px" style="border-radius: 8px">
                  </div>
                </a>
                <div class="image_book_box pl-2 float-right" style="width: 70%;">

                  <a href="{{$history->url}}" class="title_story text-dark mb-0 font-weight-bold" style="font-size: 110%;">{{$history->tentruyen}}</a>
                  <div style="clear: both;"></div>
                  <a href="{{$history->url}}" class="m-0 text-dark" style="font-size: 100%">Đọc tiếp {{$history->chapter_current}}</a>
                  <div class="tag_box" style="height: 70px;">

                  </div>
                  <form action="{{route('history.delete',[ $history -> tentruyen])}}" method="POST">
                    @method('DELETE')
                    @csrf
      ...
      @else
      <p class="text-center">Bạn chưa có lịch sử đọc truyện nào</p>
      @endif

      @else
      <div class="truyen-yeu-thich">
        <div class="btn p-2 border-0 text-center font-weight-bold w-100" style="border-radius: 8px; background: #ff631c; color: white;">Lịch sử đọc truyện</div>
        <p class="text-center">Hãy <a href="{{ route('login') }}" class="m-0" style="color:  #ff631c;">đăng nhập</a> để sử dụng tính năng này</p>
      </div>
      @endif
                ...
                <div class=" " style="width: 100%;border-radius: 8px;">
                  ...
                  <div class="image_book_box pl-2 float-right" style="width: 65%;">
                    ...
                    <a href="{{url('xem-truyen/'.$value->slug_truyen)}}" class="text-dark">
                      ...
                      <p style="font-size: 85%; color:gray" class="comment_story mt-2"> <i class="fa fa-eye mr-1"></i>{{ views($value)->count() }} lượt xem</p>
