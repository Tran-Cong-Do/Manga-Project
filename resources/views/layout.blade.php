    ...
    <div class="menu" style="width: 100%;">
      <nav>
        ...
        <ul>
          ...
          <li>
            <div class="form-group m-0 p-0">
              <!-- <select class="custom-select mr-sm-2" id="switch_color">
                <option value="trang">Giao diện sáng</option>
                <option value="den">Giao diện tối</option>
              </select> -->

              <!-- <div class="form-check form-switch">
                <input class="form-check-input" value="trang" type="hidden">
                <input class="form-check-input" value="den" type="checkbox" id="flexSwitchCheckDefault">
                <label class="form-check-label" for="flexSwitchCheckChecked">Màu giao diện</label>
              </div> -->

              <!-- Default switch -->
              <!-- <div class="custom-control custom-switch" id="switch_color">
                <input class="custom-control-input" value="trang" type="hidden">
                <input type="checkbox" value="den" class="custom-control-input" id="customSwitches">
                <label class="custom-control-label" for="customSwitches">Giao diện tối</label>
              </div> -->
          ...
          @if (Route::has('login'))
          <li class="nav-item">
            <a class="btn" style="background:  #ff631c; color: white; border-radius: 8px" href="{{ route('login') }}">{{ __('Đăng nhập') }}</a>
          </li>
          @endif
          ...
          <li class="nav-item dropdown pr-2">
            <a id="navbarDropdown" class="btn nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="background:  #ff631c; color: white; border-radius: 8px">
              @if(Auth::user()->image)
              <img class="d-flex rounded-circle z-depth-1-half mr-1 float-left" style="margin-top: 0.5px" width="20px" height="20px" src="{{asset('public/uploads/avatar/'.Auth::user()->image)}}" alt="Avatar">
              @else
              <img class="d-flex rounded-circle z-depth-1-half mr-1 float-left" style="margin-top: 0.5px" width="20px" height="20px" src="https://mdbootstrap.com/img/Photos/Avatars/avatar-10.jpg" alt="Avatar">
              @endif
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item m-0" href="{{\url('/truyen-yeu-thich',[Auth::user()->id])}}">
                <div class="icon_box float-left mr-2" style="width: 20px;height: 20px;">
                  <i class="fas fa-heart" style="color: #ff631c"></i>
                </div>
              ...
              <a class="dropdown-item m-0" href="{{route('home')}}">
                ...
                <p class="mt-1 m-0"> Quản lý </p>
              </a>
              <div class="dropdown-divider"></div>
              @else


              <a class="dropdown-item m-0" href="https://www.facebook.com/thithaotrinh.nguyen.1410">
                <!-- <div class="icon_box float-left mr-2" style="width: 20px;height: 20px;">
  ...
  <div class="container mt-2">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        var chapter_current = $('.chapter_current').val();
...
<footer>
    <div class="container p-0">
      <div class="footer-bottom">
        <p>copyright &copy;2021 <a style="color:#ff631c" href="#">Project Manga</a> </p>
        <div class="footer-menu">
          <ul class="f-menu">
            <li><a class="text-dark" href="{{url('/')}}">Trang chủ</a></li>
            <li><a class="text-dark" href="#">Liên hệ</a></li>
          </ul>
        </div>
      </div>
    </div>
