                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($reportErrTranh as $key => $reportError)
                            <tr>
                                ...
                                <th scope="row"><a href="{{url('xem-chapter/'.$reportError->chaptertranh->truyen->slug_truyen.'/'.$reportError->chaptertranh->slug_chapter)}}">{{$reportError->chaptertranh->truyen->tentruyen}}</a></th>
