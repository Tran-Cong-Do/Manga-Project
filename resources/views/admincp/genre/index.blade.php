        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="width: 100%">   
                    <a href="{{route('genre.create')}}" class="btn btn-dark mr-2 mb-2">Thêm thể loại</a>
                 </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($genre as $key => $theloai)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('genre.show',[$theloai -> id])}}" class="btn btn-success float-left mr-2"><i class="fas fa-bars"></i></a>                            
                                    <a href="{{route('genre.edit',[$theloai -> id])}}" class="btn btn-primary float-left mr-2"><i class="fas fa-edit"></i></a>
                                    <form action="{{route('genre.destroy',[ $theloai -> id])}}" method="POST">
                                        @method('DELETE')
                                        @csrf
