            ...
            <div class="card">
                ...
                <div class="card-body">
                 ...
                 <div style="width: 100%">   
                    ...
                    <a href="{{route('chapter.create')}}" class="btn btn-success float-right mr-2 mb-2">Thêm chương</a>
                 </div>
                ...
                @else
                 ...
                 <div style="width: 100%">   
                    ...
                    <a href="{{route('chaptertranh.create')}}" class="btn btn-success float-right mr-2 mb-2">Thêm chương</a>
                 </div>
                 <div style="clear: both;"></div>
                    <table class="table table-striped">
                        <thead>
